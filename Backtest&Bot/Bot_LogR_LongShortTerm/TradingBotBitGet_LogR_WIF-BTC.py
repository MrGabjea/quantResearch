...
size_batch = 700  #taille de la position de base pour les trades 
    ...
    try :
        ...
        if (chrono> 60): # attend 60min
            try :
                ...
                Btc_pos = get_Position_Info(crypto2)
                ...
                if (Wif_pos!=(pos*size_batch)):
                    try:
                        ...
                        time.sleep(1)
                        newBtc_pos = -pos*size_batch*prix1/prix2
                        market_order(crypto2, round(newBtc_pos-Btc_pos,3)) 
                        print("WIF Position Changed from ", Wif_pos,"to", (pos*size_batch))
                        print("BTC Position Changed from ", Btc_pos,"to", round(newBtc_pos,3))
                    except:
